        ...
        <div className="relative z-10 flex h-full items-center justify-center px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Strathmore Education Trust</span>
            </motion.div>
            ...
            <p className="mx-auto max-w-2xl text-lg text-slate-300 sm:text-xl">
              The enterprise arm and official business services agent of Eastlands College of Technology, 
              delivering excellence in technical training and construction services across Kenya.
            </p>
          </motion.div>
        </div>
          ...
          >
            <motion.div variants={fadeInUp} className="flex flex-col justify-center">
              ...
              <p className="mb-6 text-lg leading-relaxed text-slate-600">
                ECTES is the enterprise arm and official business services agent of Eastlands College of 
                Technology (ECT), an institution under the Strathmore Education Trust. We provide 
                technical training, production and construction services to industries and organizations 
                across Kenya.
              </p>
              <p className="text-lg leading-relaxed text-slate-600">
                Our commitment to quality, safety, and professional standards has made us a trusted 
                partner for companies, industries, institutions, and individuals seeking reliable 
                technical solutions.
              </p>
            </motion.div>
            ...
            <motion.div 
              variants={fadeInUp}
              className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 p-8 lg:p-12"
            >
              ...
              <div className="relative space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">NCA Certified</h3>
                    <p className="text-slate-600">National Construction Authority certified operations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Strathmore Trust</h3>
                    <p className="text-slate-600">Backed by Strathmore Education Trust excellence</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Industry Partnerships</h3>
                    <p className="text-slate-600">Strong collaborations with leading organizations</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  To deliver high-quality training, production and construction services through 
                  practical skills development, innovation and strong industry partnerships—driven 
                  by the standards and values of Eastlands College of Technology under the 
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg leading-relaxed text-slate-300">
                  To be a leading provider of industry-focused technical training and professional 
                  services that empower individuals, strengthen industries, and contribute to 
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-slate-600">
              We support companies, industries, institutions and individuals through comprehensive 
              technical training and professional construction services.
            </p>
          </motion.div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg shadow-slate-100 transition-all hover:shadow-xl"
            >
              <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-amber-100 text-amber-600">
                <Wrench className="h-8 w-8" />
              </div>
              <h3 className="mb-4 text-2xl font-bold text-slate-900">Technical Training Programs</h3>
              <p className="mb-6 text-slate-600">
                Comprehensive training programs for technicians and staff, designed to build 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-900">Solar PV Installation</h4>
                    <p className="text-sm text-slate-500">Photovoltaic system design and installation</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-900">Solar Heating Systems</h4>
                    <p className="text-sm text-slate-500">Solar water heating solutions</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-900">Technical Skills Development</h4>
                    <p className="text-sm text-slate-500">Industry-focused practical training</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="mb-4 text-2xl font-bold text-slate-900">Production & Construction Services</h3>
              <p className="mb-6 text-slate-600">
                Full-service construction and fabrication solutions for residential, commercial, 
      ...
      <section className="bg-slate-50 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-slate-600">
              Proud to serve leading organizations across Kenya with dedication and excellence.
            </p>
          </motion.div>
          ...
          >
            {/* Training Clients */}
            <motion.div variants={fadeInUp} className="sm:col-span-2 lg:col-span-3">
              <h3 className="mb-4 text-lg font-semibold text-slate-700">Training Clients</h3>
            </motion.div>
            ...
            {[
              ...
              >
                ...
                <h4 className="mb-1 font-semibold text-slate-900">{client.name}</h4>
                <p className="text-sm text-slate-500">{client.type}</p>
              </motion.div>
            ))}
            
            {/* Construction Clients */}
            <motion.div variants={fadeInUp} className="sm:col-span-2 lg:col-span-3 mt-6">
              <h3 className="mb-4 text-lg font-semibold text-slate-700">Construction Clients</h3>
            </motion.div>
            
            <motion.div
              variants={fadeInUp}
              className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md sm:col-span-2"
            >
              <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-lg bg-slate-800 text-white">
                <Building2 className="h-6 w-6" />
              </div>
              <h4 className="mb-1 font-semibold text-slate-900">Wanawake kwa Wanawake</h4>
              <p className="text-sm text-slate-500">Community Development Projects</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-slate-600">
              ECTES operates under strict regulatory standards to ensure quality and safety.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              >
                ...
                <h4 className="mb-2 font-semibold text-white">{cert.title}</h4>
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="mb-8 text-lg text-white/90">
              Let's discuss how we can support your training or construction needs.
            </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="text-center sm:text-left">
              ...
              <p className="text-slate-400">Eastlands College of Technology Enterprise Services</p>
            </div>
